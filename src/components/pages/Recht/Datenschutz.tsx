  ...
  return (
    <main className="flex-1 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16" role="main" aria-labelledby="datenschutz-title">
      ...
      <article className="prose prose-slate max-w-none">
        ...
        <strong>Rechtsgrundlagen:</strong> § 26 Abs. 1 BDSG, Art. 6 Abs. 1 lit. b DSGVO; bei Einwilligung (Talentpool): Art. 6 Abs. 1 lit. a DSGVO; besondere Kategorien gem. Art. 9 Abs. 2 DSGVO.</p>
