...
export default function Umweltmanagement(){
  return (
    <main className="flex-1 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16">
      <h1 className="text-3xl md:text-4xl font-semibold">Umweltmanagement</h1>
      <div className="h-3 bg-gradient-to-r from-blue-800 via-blue-600 to-green-500 opacity-30 rounded-full mt-3 mb-5" />
      <p className="mt-3 text-slate-700 max-w-3xl">Informationen zu unserem Umweltmanagement, Zielen zur Emissionsreduzierung und nachhaltigen Prozessen.</p>
    </main>
  )
}
